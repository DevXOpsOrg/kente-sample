...
//
//     // Check if maintenance/package.json exists otherwise throw warning
//     const maintenanceJson = path.join(cfaRoot, jsonFilePath, 'package.json');
//
...
// ) {
//     try {
//         // Read maintenance package.json
//         const rawMaintenanceData = readFileSync(maintenanceJson, 'utf8');
//         const maintenanceJsonData = JSON.parse(rawMaintenanceData);
//
//         // Read projects package.json
//         const rawPackageData = readFileSync(path.join(appDirectory, 'package.json'), 'utf8');
...
//         appendFileSync(path.join(appDirectory, 'package.json'), '\n', 'utf-8');
//
